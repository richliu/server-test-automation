...
def bmc_ssh_execute_command(cmd_buf,
                        print_out=0,
                        print_err=0,
                        ignore_err=0,
                        fork=0,
    ...
    # Get global BMC variable values.
    openbmc_host = BuiltIn().get_variable_value("${OPENBMC_HOST}", default="")
    openbmc_username = BuiltIn().get_variable_value("${OPENBMC_SSH_USERNAME}",
                                                    default="")
    openbmc_password = BuiltIn().get_variable_value("${OPENBMC_SSH_PASSWORD}",
                                                    default="")
    openbmc_prompt   = BuiltIn().get_variable_value("${OPENBMC_PROMPT}",
                                                    default="")
